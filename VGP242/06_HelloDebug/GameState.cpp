...
{
	mSunRotation += 0.1f * deltaTime;

	// the closer planets go faster
	mMercuryRotation += 0.8f * deltaTime;
	mMercuryOrbitRotation += 0.5f * deltaTime;

	mVenusRotation += 0.6f * deltaTime;
	mVenusOrbitRotation += 0.35f * deltaTime;
	...
	mJupiterRotation += 1.0f * deltaTime;
	mJupiterOrbitRotation += 0.1f * deltaTime;

	mSaturnRotation += 0.9f * deltaTime;
	mSaturnOrbitRotation += 0.08f * deltaTime;

	mUranusRotation += 0.7f * deltaTime;
	mUranusOrbitRotation += 0.06f * deltaTime;

	mNeptuneRotation += 0.7f * deltaTime;
	mNeptuneOrbitRotation += 0.05f * deltaTime;
