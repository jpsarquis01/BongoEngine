...
{
	ASSERT(sTextureManager == nullptr, "TextureManager already initialized");
...
{
	ASSERT(sTextureManager != nullptr, "TextureManager not initialized");
	return sTextureManager.get();
}

TextureManager::~TextureManager()
{
	ASSERT(mInventory.empty(), "TextureManager inventory not empty on termination");
}
